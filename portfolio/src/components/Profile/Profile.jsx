    ...
    return(
        ...
        <div className="row pl-5">
            <div className="bg-white col-md-12 col-lg-3 text-sm-center">
                ...
                <a href="https://github.com/abnish07" target="_blank"><i class="fab fa-github-square socialIcon"></i></a> 
                
                <a href="https://www.hackerrank.com/abnish35" target="_blank"><i class="fab fa-hackerrank socialIcon"></i></a>

                <a href="https://www.linkedin.com/in/abnish-07/" target="_blank"><i class="fab fa-linkedin socialIcon"></i></a>

                <a href="https://twitter.com/abnish07" target="_blank"><i class="fab fa-twitter-square socialIcon"></i></a>
               </div></div>
            </div>   
